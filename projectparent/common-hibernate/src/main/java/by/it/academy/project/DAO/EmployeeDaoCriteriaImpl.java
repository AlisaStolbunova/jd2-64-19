...
public class EmployeeDaoCriteriaImpl implements EmployeeDao {

    private static final EmployeeDaoCriteriaImpl INSTANCE = new EmployeeDaoCriteriaImpl();

    public static EmployeeDaoCriteriaImpl getINSTANCE() {
        return INSTANCE;
    }
    ...
    public Double getMaxSalary() {
        ...
        Session session = sessionFactory.openSession();
        Long maxSalary = session.createQuery(criteria).getSingleResult();
        session.close();
    ...
    public Integer getMinAge() {
        ...
        Session session = sessionFactory.openSession();
        Integer minAge = session.createQuery(criteria).getSingleResult();
        session.close();
        return minAge;
    }
    ...
    public Double getAverageSalaryByDep(Long depId) {
        ...
        criteria.select(cb.avg(employee.get("salary"))).where(cb.equal(employeeJoin.get("departmentId"), depId));
        Session session = sessionFactory.openSession();
        Double avg = session.createQuery(criteria).getSingleResult();
        return avg;
    }
